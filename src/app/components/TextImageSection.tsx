...
const SubHeader = ({ children }) => (
	<span className="text-orange-600 flex self-center lg:self-start">
		<svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
				...
				fill="rgb(234 88 12 / var(--tw-bg-opacity))"
			></path>
			<path
...
const Section = ({ id, imageSrc, altText, header, subHeader, paragraphs, link }) => (
	<section
		id={id}
		className="py-16  flex flex-col justify-between lg:flex-row px-3 xl:px-0 lg:mb-5 "
	...
	>
		...
		<div className="w-full xl:w-1/2 ps-5 ">
			<div className="mx- w- text-center lg:text-start xl:max-w-3xl xl:pe-5 h-full flex flex-col   xl:mt-0 pe-8 ">
